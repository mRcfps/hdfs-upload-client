...
public class SwitchBarsComposite extends Composite {
	 ...
	 * @param style
	 */
	public SwitchBarsComposite(Composite parent, int style, UpComposite upc, UpedComposite uc) {
		super(parent, style);
		createContents();
		this.upc = upc;
		this.uc = uc;
	...
	protected void createContents() {
		...
		bt_left.setImage(SWTResourceManager.getImage(SwitchBarsComposite.class, "/images/zhengzaichuanshu_highlight.png"));
		bt_right.setImage(SWTResourceManager.getImage(SwitchBarsComposite.class, "/images/chuanshuwc_gray.png"));
		...
		bt_right.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				uc.setVisible(true);
				bt_left.setImage(SWTResourceManager.getImage(SwitchBarsComposite.class, "/images/zhengzaichuanshu_gray.png"));
				bt_right.setImage(SWTResourceManager.getImage(SwitchBarsComposite.class, "/images/chuanshuwc_highlight.png"));
