...
//		createContents();
//	}
	public LastComposite2(Composite parent, int style, String caseid) {
		super(parent, style);
		this.parent = (Shell) parent;
		this.caseid = caseid;
		System.out.println("+6++++"+caseid);
	...
	protected void createContents() {
		setSize(1024, 900);
		setBackground(new Color(Display.getDefault(), 247, 249, 249));
		// 返回按钮一栏的标签
//				Composite composite2 = new Composite(this, SWT.NONE);
//				composite2.setBackgroundMode(SWT.INHERIT_DEFAULT);
//				composite2.setBackground(new Color(Display.getDefault(), 247, 249, 249));
//				composite2.setBounds(0, 90, 1024, 44);

				btnNewButton_1 = new Button(this, SWT.NONE);
				btnNewButton_1.setBounds(10, 100, 90, 23);
				btnNewButton_1.addSelectionListener(new SelectionAdapter() {
					@Override
					public void widgetSelected(SelectionEvent e) {
						MainShell2 shell = (MainShell2) getShell();
						dispose();
						shell.setVisible(true);
						shell.table_1.setVisible(true);
						System.out.println("-----shell.isVisible()"+shell.isVisible());
					}
				});
				btnNewButton_1.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 50, SWT.NORMAL));
				btnNewButton_1.setImage(SWTResourceManager.getImage(LastComposite2.class, "/images/fanhui.png"));
		...
		typelabel.setBackground(new Color(Display.getDefault(), 247, 249, 249));
		typelabel.setFont(SWTResourceManager.getFont("微软雅黑", 11, SWT.NORMAL));
		typelabel.setAlignment(SWT.RIGHT);
		typelabel.setBounds(23, 142, 90, 23);
		...
		dirlabel.setBackground(new Color(Display.getDefault(), 247, 249, 249));
		dirlabel.setFont(SWTResourceManager.getFont("微软雅黑", 11, SWT.NORMAL));
		dirlabel.setAlignment(SWT.RIGHT);
		dirlabel.setBounds(23, 192, 90, 23);
		...
		evnamelabel.setBackground(new Color(Display.getDefault(), 247, 249, 249));
		evnamelabel.setFont(SWTResourceManager.getFont("微软雅黑", 11, SWT.NORMAL));
		evnamelabel.setAlignment(SWT.RIGHT);
		evnamelabel.setBounds(23, 242, 90, 23);
		...
		evdesclabel.setBackground(new Color(Display.getDefault(), 247, 249, 249));
		evdesclabel.setFont(SWTResourceManager.getFont("微软雅黑", 11, SWT.NORMAL));
		evdesclabel.setAlignment(SWT.RIGHT);
		evdesclabel.setBounds(23, 291, 90, 23);
		...
		datasources.setBackground(new Color(Display.getDefault(), 247, 249, 249));
		datasources.setFont(SWTResourceManager.getFont("微软雅黑", 11, SWT.NORMAL));
		datasources.setAlignment(SWT.RIGHT);
		datasources.setBounds(23, 340, 90, 23);
		datasources.setText("数据来源");
		
		/*Label prompt = new Label(this, SWT.NONE);
		prompt.setForeground(SWTResourceManager.getColor(new RGB(200, 85, 85)));
		prompt.setBackground(new Color(Display.getDefault(), 247, 249, 249));
		prompt.setFont(SWTResourceManager.getFont("微软雅黑", 11, SWT.NORMAL));
		prompt.setAlignment(SWT.RIGHT);
		prompt.setBounds(40, 100, 450, 23);
		prompt.setText("提示：为保持上传稳定性，建议每次传输数据不超过150G");*/
		...
		dataType.setBounds(122, 142, 358, 100);//数据源类型
		dataType.add("电子邮件");
		dataType.add("综合文档");
		dataType.add("电子话单");
		// dataType.add("手机取证");
		...
		dataSources.setFont(SWTResourceManager.getFont("微软雅黑", 11, SWT.NORMAL));
		dataSources.setBounds(122, 340, 358, 50);
		...
		localsrc.setBounds(122, 192, 358, 28);//选择目录

		text_evi = new Text(this, SWT.BORDER);
		text_evi.setBounds(122, 242, 358, 28);//数据名称

		text_evi_desc = new Text(this, SWT.BORDER);
		text_evi_desc.setBounds(122, 291, 358, 28);//数据描述

		upbt = new Button(this, SWT.NONE);
		final LastComposite2 tmp = this;
...
//					JOptionPane.showMessageDialog(null, "若文件夹中有其他类型数据，该数据已移动到"+fi2+"目录下", "提示", JOptionPane.INFORMATION_MESSAGE);
					...
					public void run() {					
						Display.getDefault().asyncExec(new Runnable() {
							...
							public void run() {
								...
								text_log.append("开始上传，上传过程中请勿进行其他操作" +"\r\n");
							}
						});
						try {
							ContinueUpload.uploadLinux(loc, evName, caseid, type, comment,LoginShell.userName, dataSourcesType+"",tmp,LoginShell.policeNO);
						} catch (Exception e1) {
							e1.printStackTrace();
						}
						finished = true;
		...
		upbt.setBounds(122, 400, 358, 34);//上传按钮的位置
		upbt.setImage(SWTResourceManager.getImage(LastComposite2.class, "/images/upbt_highlight.png"));
		...
		text_log.setBounds(552, 141, 440, 380);//日志展示的位置

		Label label = new Label(this, SWT.SEPARATOR | SWT.HORIZONTAL);
		label.setBounds(18, 450, 476, 2);

		progressBar = new ProgressBar(this, SWT.NONE);
		progressBar.setBounds(32, 470, 448, 20);//进度条的位置

//		Label label_1 = new Label(this, SWT.NONE);
//		label_1.setForeground(SWTResourceManager.getColor(new RGB(153, 153, 153)));
//		label_1.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
//		label_1.setBounds(36, 500, 61, 17);
//		label_1.setText("已上传数:");
		...
		label_2.setBounds(393, 500, 27, 17);
...
//		label_upNum.setBounds(100, 500, 108, 17);
		...
		label_usedTime.setBounds(426, 500, 48, 17);
	}
...
//					if (!dir.toString().endsWith("eml")&&!dir.toString().endsWith("tar")&&!dir.toString().endsWith("tar.gz")) {
//						try{
